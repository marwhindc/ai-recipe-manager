## DEFERRED — AI Video Pipeline

> **Status:** Out of scope for the `recipes-feature` change. All requirements in this file are deferred to a dedicated follow-up change.
