# Capability: link-recipe-import-ui

## Purpose
Define the frontend experience for importing recipes from source links, including the entry point, link submission, draft hydration into the recipe form, and error handling.
